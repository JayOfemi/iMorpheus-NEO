...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    { "imcoin",           "name_show",              &name_show,              false },
    { "imcoin",           "name_history",           &name_history,           false },
    { "imcoin",           "name_scan",              &name_scan,              false },
    { "imcoin",           "name_filter",            &name_filter,            false },
    { "imcoin",           "name_pending",           &name_pending,           true  },
    { "imcoin",           "name_checkdb",           &name_checkdb,           false },
};
