...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s imcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  imcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded imcoin transaction") + "\n" +
              "  imcoin-tx [options] -create [commands]   " + _("Create hex-encoded imcoin transaction") + "\n" +
              "\n";
