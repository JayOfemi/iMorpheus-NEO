...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitcoin Core and Imcoin developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitcoin Core and Imcoin"
...
#define PACKAGE_BUGREPORT "https://github.com/imcoin/imcoin-core/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Imcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Imcoin Core 0.13.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "imcoin"
